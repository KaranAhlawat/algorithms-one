...
public class Point implements Comparable<Point> {
    ...
    private static class BySlope implements Comparator<Point> {
        ...
        public int compare(Point p1, Point p2) {
            double slope1 = this.p.slopeTo(p1);
            double slope2 = this.p.slopeTo(p2);
    ...
    public static void main(String[] args) {
        ...
        System.out.println(p0.slopeTo(new Point(30, 1))); // approx 0.033333
        ...
        System.out.println(p0.compareTo(new Point(-1, 0))); // 1
        System.out.println(p0.compareTo(new Point(0, -0))); // 0
        System.out.println(p0.compareTo(new Point(2, 2))); // -2
        System.out.println(p0.compareTo(new Point(-2, 5))); // -5
        System.out.println(p0.compareTo(new Point(333, -0))); // -333
        System.out.println(p0.compareTo(new Point(0, 3333))); // -3333
    }
}
